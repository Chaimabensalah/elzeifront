...
export class SalariesdetailsComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder , private activatRoute:ActivatedRoute ,   private router: Router, private salariesService: SalariesService,private datePipe: DatePipe) {  this.currentDate = this.datePipe.transform(new Date(), 'yyyy-MM-dd') || ''}
